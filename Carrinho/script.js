...
function carrinhoVazio() {
    ...
    if (items === null) {
        ...
        carrinhoExibir.innerHTML = `
     <div class="noProduct">
            <div class="small-title">Seu carrinho do Está vazio</div>
...
function mensagem() {
    ...
    var mensagemWhats = 'https://api.whatsapp.com/send?l=pt_BR&phone=556599758995&text=';

    mensagemWhats += "Boa%20noite%20pessoal,%0Agostaria%20de%20pedir:%0A";
    ...
    totalFinal = totalFinal.reduce((totalFinal, currentElement) => totalFinal + currentElement);
    mensagemWhats += `%0ATotal: ${totalFinal.toLocaleString('pt-BR', { style: 'currency', currency: 'BRL' })}`;
